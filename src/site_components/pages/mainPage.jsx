	...
	return [
		<section className="container" style={{
			...
			<div style={{
				...
				<p>Hi! I'm Mark (a.k.a. krawthekrow or mark2222), and my dream is to become a wizard. The spell of the day is <script type="text/javascript" dangerouslySetInnerHTML={{__html: `
					const options = [
						${
				...
				<div dangerouslySetInnerHTML={{__html: '<!-- No, I\'m not actually a Harry Potter fan. That was an inside joke. Actually this whole page is an inside joke. -->'}}></div>
			</div>
		</section>,
		<section className="container" style={{
			maxWidth: '500px',
